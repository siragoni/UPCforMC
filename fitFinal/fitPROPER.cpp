...
void fitROOFit(const char* AnalysisName, const int selectionFlag){
  ...
  RooRealVar      lambda      ("lambda",       "lambda",    -0.6, -0.7, -0.5   );
  ...
  RooRealVar      a2v         ("a2v",           "quadratic height", parametersForTheFitVector[0]*1.07);
  RooRealVar      a3v         ("a3v",           "cubic height",     parametersForTheFitVector[1]*1.);
  RooRealVar      a4v         ("a4v",           "quartic height",   parametersForTheFitVector[2]*1.02);
  ...
  if      ( selectionFlag == 0 ) gPad->SaveAs("pngResults/InvariantMassDimuonCompleteFit.png",           "RECREATE");
  else if ( selectionFlag == 1 ) gPad->SaveAs("pngResults/InvariantMassDimuonCompleteFitCoherent.png",   "RECREATE");
  else if ( selectionFlag == 2 ) gPad->SaveAs("pngResults/InvariantMassDimuonCompleteFitIncoherent.png", "RECREATE");
