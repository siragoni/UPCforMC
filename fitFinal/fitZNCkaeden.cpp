...
void fitZNC(const char* AnalysisName){
  ...
  RooFormulaVar   sigma1Neutron ("sigma1Neutron",  "",    "sqrt(2)*sigma0Neutrons", sigma0Neutrons);
  RooFormulaVar   sigma2Neutrons("sigma2Neutrons", "",    "sqrt(3)*sigma0Neutrons", sigma0Neutrons);
  RooFormulaVar   sigma3Neutrons("sigma3Neutrons", "",    "2*sigma0Neutrons"      , sigma0Neutrons);
  RooFormulaVar   mean2Neutrons ("mean2Neutrons",  "",    "sqrt(3)*mean1Neutron"  , mean1Neutron  );
  RooFormulaVar   mean3Neutrons ("mean3Neutrons",  "",    "2*mean1Neutron"        , mean1Neutron  );
  ...
  gPad->SaveAs("pngResults/fZNCEnergyKaeden.png", "RECREATE");
}
