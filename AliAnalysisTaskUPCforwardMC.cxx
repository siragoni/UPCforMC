...
AliAnalysisTaskUPCforwardMC::AliAnalysisTaskUPCforwardMC()
    : AliAnalysisTaskSE(),
      ...
      // Study for AxE effect
      fPhiRestrictedRangeHE(-999.),
      fMCPhiRestrictedRangeHE(-999.),
      fTildePhiRestrictedRangeHE(-999.),
      fMCTildePhiRestrictedRangeHE(-999.),
      fPhiRestrictedRangeCS(-999.),
      fMCPhiRestrictedRangeCS(-999.),
      fTildePhiRestrictedRangeCS(-999.),
      fMCTildePhiRestrictedRangeCS(-999.),
      fCounterUPCevent(0),
      ...
      fPhiHelicityFrameTwentyfiveBinsHv2(0),
      fPhiHelicityFrameTwentyfiveBinsHv2_restrict(0),
      fMCPhiHelicityFrameTwentyfiveBinsH(0),
      fMCPhiHelicityFrameTwentyfiveBinsHv2(0),
      fMCPhiHelicityFrameTwentyfiveBinsHv2_restrict(0),
      fTildePhiHelicityFrameTwentyfiveBinsH(0),
      fTildePhiHelicityFrameTwentyfiveBinsHv2(0),
      fTildePhiHelicityFrameTwentyfiveBinsHv2_restrict(0),
      fMCTildePhiHelicityFrameTwentyfiveBinsH(0),
      fMCTildePhiHelicityFrameTwentyfiveBinsHv2(0),
      fMCTildePhiHelicityFrameTwentyfiveBinsHv2_restrict(0),
      ...
      fPhiHelicityFrameTwentyfiveBinsTriggerHv2{0,0,0,0,0,0,0},
      fMCPhiHelicityFrameTwentyfiveBinsTriggerH{0,0,0,0,0,0,0},
      fMCPhiHelicityFrameTwentyfiveBinsTriggerHv2{0,0,0,0,0,0,0},
      fTildePhiHelicityFrameTwentyfiveBinsTriggerH{0,0,0,0,0,0,0},
      fTildePhiHelicityFrameTwentyfiveBinsTriggerHv2{0,0,0,0,0,0,0},
      fMCTildePhiHelicityFrameTwentyfiveBinsTriggerH{0,0,0,0,0,0,0},
      fMCTildePhiHelicityFrameTwentyfiveBinsTriggerHv2{0,0,0,0,0,0,0},
      ...
      fPhiCsFrameTwentyfiveBinsHv2(0),
      fPhiCsFrameTwentyfiveBinsHv2_restrict(0),
      fMCPhiCsFrameTwentyfiveBinsH(0),
      fMCPhiCsFrameTwentyfiveBinsHv2(0),
      fMCPhiCsFrameTwentyfiveBinsHv2_restrict(0),
      fTildePhiCsFrameTwentyfiveBinsH(0),
      fTildePhiCsFrameTwentyfiveBinsHv2(0),
      fTildePhiCsFrameTwentyfiveBinsHv2_restrict(0),
      fMCTildePhiCsFrameTwentyfiveBinsH(0),
      fMCTildePhiCsFrameTwentyfiveBinsHv2(0),
      fMCTildePhiCsFrameTwentyfiveBinsHv2_restrict(0),
      ...
      fPhiCsFrameTwentyfiveBinsTriggerHv2{0,0,0,0,0,0,0},
      fMCPhiCsFrameTwentyfiveBinsTriggerH{0,0,0,0,0,0,0},
      fMCPhiCsFrameTwentyfiveBinsTriggerHv2{0,0,0,0,0,0,0},
      fTildePhiCsFrameTwentyfiveBinsTriggerH{0,0,0,0,0,0,0},
      fTildePhiCsFrameTwentyfiveBinsTriggerHv2{0,0,0,0,0,0,0},
      fMCTildePhiCsFrameTwentyfiveBinsTriggerH{0,0,0,0,0,0,0},
      fMCTildePhiCsFrameTwentyfiveBinsTriggerHv2{0,0,0,0,0,0,0},
      // Sidebands
      ...
      // INCOHERENT
      fCosThetaHelicityFrameTwentyfiveBinsIncohH(0),
      fMCCosThetaHelicityFrameTwentyfiveBinsIncohH(0),
      fPhiHelicityFrameTwentyfiveBinsIncohH(0),
      fMCPhiHelicityFrameTwentyfiveBinsIncohH(0),
      fTildePhiHelicityFrameTwentyfiveBinsIncohH(0),
      fMCTildePhiHelicityFrameTwentyfiveBinsIncohH(0),
      fCosThetaCsFrameTwentyfiveBinsIncohH(0),
      fMCCosThetaCsFrameTwentyfiveBinsIncohH(0),
      fPhiCsFrameTwentyfiveBinsIncohH(0),
      fMCPhiCsFrameTwentyfiveBinsIncohH(0),
      fTildePhiCsFrameTwentyfiveBinsIncohH(0),
      fMCTildePhiCsFrameTwentyfiveBinsIncohH(0),
      // Checks for 2D maps
      ...
      fYGenerated(0),
      fCosThetaHEtoCSH(0),
      fMCCosThetaHEtoCSH(0),
      fTildePhiGeneratedHelicityFramePos(0),
      fTildePhiGeneratedHelicityFrameNeg(0),
      fCosThetaRecMinusGenHelicityH(0),
      fCosThetaRecMinusGenHelicityRelativeH(0),
      fPhiRecMinusGenHelicityH(0),
      fPhiRecMinusGenHelicityRelativeH(0),
      fTildePhiRecMinusGenHelicityH(0),
      fTildePhiRecMinusGenHelicityRelativeH(0),
      fPhiRecVsGenHelicityH(0),
      fPhiRecVsGenCSH(0),
      fTildePhiRecVsGenHelicityH(0),
      fTildePhiRecVsGenCSH(0)
...
void AliAnalysisTaskUPCforwardMC::UserCreateOutputObjects()
{
  ...
  fCosThetaHEtoCSH = new TH1F( "fCosThetaHEtoCSH", "fCosThetaHEtoCSH", 100000 , -1, 1 );
  fOutputList->Add(fCosThetaHEtoCSH);

  fMCCosThetaHEtoCSH = new TH1F( "fMCCosThetaHEtoCSH", "fMCCosThetaHEtoCSH", 100000, -1, 1 );
  fOutputList->Add(fMCCosThetaHEtoCSH);
  ...
  fPhiHelicityFrameTwentyfiveBinsHv2 =
        new TH1F( "fPhiHelicityFrameTwentyfiveBinsHv2",
                  "fPhiHelicityFrameTwentyfiveBinsHv2",
                  25, 0, 2.*TMath::Pi()
                  );
  fOutputList->Add(fPhiHelicityFrameTwentyfiveBinsHv2);

  fPhiHelicityFrameTwentyfiveBinsHv2_restrict =
        new TH1F( "fPhiHelicityFrameTwentyfiveBinsHv2_restrict",
                  "fPhiHelicityFrameTwentyfiveBinsHv2_restrict",
                  25, 0, 2.*TMath::Pi()
                  );
  fOutputList->Add(fPhiHelicityFrameTwentyfiveBinsHv2_restrict);
  ...
  fMCPhiHelicityFrameTwentyfiveBinsHv2 =
        new TH1F( "fMCPhiHelicityFrameTwentyfiveBinsHv2",
                  "fMCPhiHelicityFrameTwentyfiveBinsHv2",
                  25, 0, 2.*TMath::Pi()
                  );
  fOutputList->Add(fMCPhiHelicityFrameTwentyfiveBinsHv2);

  fMCPhiHelicityFrameTwentyfiveBinsHv2_restrict =
        new TH1F( "fMCPhiHelicityFrameTwentyfiveBinsHv2_restrict",
                  "fMCPhiHelicityFrameTwentyfiveBinsHv2_restrict",
                  25, 0, 2.*TMath::Pi()
                  );
  fOutputList->Add(fMCPhiHelicityFrameTwentyfiveBinsHv2_restrict);
  ...
  fTildePhiHelicityFrameTwentyfiveBinsHv2 =
        new TH1F( "fTildePhiHelicityFrameTwentyfiveBinsHv2",
                  "fTildePhiHelicityFrameTwentyfiveBinsHv2",
                  // 25, -3.14*7.0*0.25, 3.14*3.0*0.25
                  25, 0, 2.*TMath::Pi()
                  );
  fOutputList->Add(fTildePhiHelicityFrameTwentyfiveBinsHv2);

  fTildePhiHelicityFrameTwentyfiveBinsHv2_restrict =
        new TH1F( "fTildePhiHelicityFrameTwentyfiveBinsHv2_restrict",
                  "fTildePhiHelicityFrameTwentyfiveBinsHv2_restrict",
                  // 25, -3.14*7.0*0.25, 3.14*3.0*0.25
                  25, 0, 2.*TMath::Pi()
                  );
  fOutputList->Add(fTildePhiHelicityFrameTwentyfiveBinsHv2_restrict);
  ...
  fMCTildePhiHelicityFrameTwentyfiveBinsHv2 =
        new TH1F( "fMCTildePhiHelicityFrameTwentyfiveBinsHv2",
                  "fMCTildePhiHelicityFrameTwentyfiveBinsHv2",
                  // 25, -3.14*7.0*0.25, 3.14*3.0*0.25
                  25, 0, 2.*TMath::Pi()
                  );
  fOutputList->Add(fMCTildePhiHelicityFrameTwentyfiveBinsHv2);

  fMCTildePhiHelicityFrameTwentyfiveBinsHv2_restrict =
        new TH1F( "fMCTildePhiHelicityFrameTwentyfiveBinsHv2_restrict",
                  "fMCTildePhiHelicityFrameTwentyfiveBinsHv2_restrict",
                  // 25, -3.14*7.0*0.25, 3.14*3.0*0.25
                  25, 0, 2.*TMath::Pi()
                  );
  fOutputList->Add(fMCTildePhiHelicityFrameTwentyfiveBinsHv2_restrict);
  ...
  for ( Int_t iTrigger = 0; iTrigger < 7; iTrigger++ ) {
    fPhiHelicityFrameTwentyfiveBinsTriggerHv2[iTrigger] =
          new TH1F( Form("fPhiHelicityFrameTwentyfiveBinsTriggerHv2_%d", iTrigger),
                    Form("fPhiHelicityFrameTwentyfiveBinsTriggerHv2_%d", iTrigger),
                    25, 0, 2.*TMath::Pi()
                    );
    fOutputList->Add(fPhiHelicityFrameTwentyfiveBinsTriggerHv2[iTrigger]);
  }
  ...
  for ( Int_t iTrigger = 0; iTrigger < 7; iTrigger++ ) {
    fTildePhiHelicityFrameTwentyfiveBinsTriggerHv2[iTrigger] =
          new TH1F( Form("fTildePhiHelicityFrameTwentyfiveBinsTriggerHv2_%d", iTrigger),
                    Form("fTildePhiHelicityFrameTwentyfiveBinsTriggerHv2_%d", iTrigger),
                    25, 0, 2.*TMath::Pi()
                    );
    fOutputList->Add(fTildePhiHelicityFrameTwentyfiveBinsTriggerHv2[iTrigger]);
  }
  ...
  fPhiCsFrameTwentyfiveBinsHv2 =
        new TH1F( "fPhiCsFrameTwentyfiveBinsHv2",
                  "fPhiCsFrameTwentyfiveBinsHv2",
                  25, 0, 2.*TMath::Pi()
                  );
  fOutputList->Add(fPhiCsFrameTwentyfiveBinsHv2);

  fPhiCsFrameTwentyfiveBinsHv2_restrict =
        new TH1F( "fPhiCsFrameTwentyfiveBinsHv2_restrict",
                  "fPhiCsFrameTwentyfiveBinsHv2_restrict",
                  25, 0, 2.*TMath::Pi()
                  );
  fOutputList->Add(fPhiCsFrameTwentyfiveBinsHv2_restrict);
  ...
  fMCPhiCsFrameTwentyfiveBinsHv2 =
        new TH1F( "fMCPhiCsFrameTwentyfiveBinsHv2",
                  "fMCPhiCsFrameTwentyfiveBinsHv2",
                  25, 0, 2.*TMath::Pi()
                  );
  fOutputList->Add(fMCPhiCsFrameTwentyfiveBinsHv2);

  fMCPhiCsFrameTwentyfiveBinsHv2_restrict =
        new TH1F( "fMCPhiCsFrameTwentyfiveBinsHv2_restrict",
                  "fMCPhiCsFrameTwentyfiveBinsHv2_restrict",
                  25, 0, 2.*TMath::Pi()
                  );
  fOutputList->Add(fMCPhiCsFrameTwentyfiveBinsHv2_restrict);
  ...
  fTildePhiCsFrameTwentyfiveBinsHv2 =
        new TH1F( "fTildePhiCsFrameTwentyfiveBinsHv2",
                  "fTildePhiCsFrameTwentyfiveBinsHv2",
                  // 25, -3.14*7.0*0.25, 3.14*3.0*0.25
                  25, 0, 2.*TMath::Pi()
                  );
  fOutputList->Add(fTildePhiCsFrameTwentyfiveBinsHv2);

  fTildePhiCsFrameTwentyfiveBinsHv2_restrict =
        new TH1F( "fTildePhiCsFrameTwentyfiveBinsHv2_restrict",
                  "fTildePhiCsFrameTwentyfiveBinsHv2_restrict",
                  // 25, -3.14*7.0*0.25, 3.14*3.0*0.25
                  25, 0, 2.*TMath::Pi()
                  );
  fOutputList->Add(fTildePhiCsFrameTwentyfiveBinsHv2_restrict);
  ...
  fMCTildePhiCsFrameTwentyfiveBinsHv2 =
        new TH1F( "fMCTildePhiCsFrameTwentyfiveBinsHv2",
                  "fMCTildePhiCsFrameTwentyfiveBinsHv2",
                  // 25, -3.14*7.0*0.25, 3.14*3.0*0.25
                  25, 0, 2.*TMath::Pi()
                  );
  fOutputList->Add(fMCTildePhiCsFrameTwentyfiveBinsHv2);

  fMCTildePhiCsFrameTwentyfiveBinsHv2_restrict =
        new TH1F( "fMCTildePhiCsFrameTwentyfiveBinsHv2_restrict",
                  "fMCTildePhiCsFrameTwentyfiveBinsHv2_restrict",
                  // 25, -3.14*7.0*0.25, 3.14*3.0*0.25
                  25, 0, 2.*TMath::Pi()
                  );
  fOutputList->Add(fMCTildePhiCsFrameTwentyfiveBinsHv2_restrict);
  ...
  for ( Int_t iTrigger = 0; iTrigger < 7; iTrigger++ ) {
    fPhiCsFrameTwentyfiveBinsTriggerHv2[iTrigger] =
          new TH1F( Form("fPhiCsFrameTwentyfiveBinsTriggerHv2_%d", iTrigger),
                    Form("fPhiCsFrameTwentyfiveBinsTriggerHv2_%d", iTrigger),
                    25, 0, 2.*TMath::Pi()
                    );
    fOutputList->Add(fPhiCsFrameTwentyfiveBinsTriggerHv2[iTrigger]);
  }
  ...
  for ( Int_t iTrigger = 0; iTrigger < 7; iTrigger++ ) {
    fTildePhiCsFrameTwentyfiveBinsTriggerHv2[iTrigger] =
          new TH1F( Form("fTildePhiCsFrameTwentyfiveBinsTriggerHv2_%d", iTrigger),
                    Form("fTildePhiCsFrameTwentyfiveBinsTriggerHv2_%d", iTrigger),
                    25, 0, 2.*TMath::Pi()
                    );
    fOutputList->Add(fTildePhiCsFrameTwentyfiveBinsTriggerHv2[iTrigger]);
  }
  ...
  // Incoherent
  //
  fCosThetaHelicityFrameTwentyfiveBinsIncohH =
        new TH1F( "fCosThetaHelicityFrameTwentyfiveBinsIncohH",
                  "fCosThetaHelicityFrameTwentyfiveBinsIncohH",
                  25, -1, 1
                  // 100, -1, 1 // Reweighting
                  );
  fOutputList->Add(fCosThetaHelicityFrameTwentyfiveBinsIncohH);

  fMCCosThetaHelicityFrameTwentyfiveBinsIncohH =
        new TH1F( "fMCCosThetaHelicityFrameTwentyfiveBinsIncohH",
                  "fMCCosThetaHelicityFrameTwentyfiveBinsIncohH",
                  25, -1, 1
                  // 100, -1, 1 // Reweighting
                  );
  fOutputList->Add(fMCCosThetaHelicityFrameTwentyfiveBinsIncohH);

  fPhiHelicityFrameTwentyfiveBinsIncohH =
        new TH1F( "fPhiHelicityFrameTwentyfiveBinsIncohH",
                  "fPhiHelicityFrameTwentyfiveBinsIncohH",
                  25, -3.14, 3.14
                  );
  fOutputList->Add(fPhiHelicityFrameTwentyfiveBinsIncohH);

  fMCPhiHelicityFrameTwentyfiveBinsIncohH =
        new TH1F( "fMCPhiHelicityFrameTwentyfiveBinsIncohH",
                  "fMCPhiHelicityFrameTwentyfiveBinsIncohH",
                  25, -3.14, 3.14
                  );
  fOutputList->Add(fMCPhiHelicityFrameTwentyfiveBinsIncohH);

  fTildePhiHelicityFrameTwentyfiveBinsIncohH =
        new TH1F( "fTildePhiHelicityFrameTwentyfiveBinsIncohH",
                  "fTildePhiHelicityFrameTwentyfiveBinsIncohH",
                  // 25, -3.14*7.0*0.25, 3.14*3.0*0.25
                  25, 0, 2. * 3.14
                  );
  fOutputList->Add(fTildePhiHelicityFrameTwentyfiveBinsIncohH);

  fMCTildePhiHelicityFrameTwentyfiveBinsIncohH =
        new TH1F( "fMCTildePhiHelicityFrameTwentyfiveBinsIncohH",
                  "fMCTildePhiHelicityFrameTwentyfiveBinsIncohH",
                  // 25, -3.14*7.0*0.25, 3.14*3.0*0.25
                  25, 0, 2. * 3.14
                  );
  fOutputList->Add(fMCTildePhiHelicityFrameTwentyfiveBinsIncohH);

  fCosThetaCsFrameTwentyfiveBinsIncohH =
        new TH1F( "fCosThetaCsFrameTwentyfiveBinsIncohH",
                  "fCosThetaCsFrameTwentyfiveBinsIncohH",
                  25, -1, 1
                  // 100, -1, 1 // Reweighting
                  );
  fOutputList->Add(fCosThetaCsFrameTwentyfiveBinsIncohH);

  fMCCosThetaCsFrameTwentyfiveBinsIncohH =
        new TH1F( "fMCCosThetaCsFrameTwentyfiveBinsIncohH",
                  "fMCCosThetaCsFrameTwentyfiveBinsIncohH",
                  25, -1, 1
                  // 100, -1, 1 // Reweighting
                  );
  fOutputList->Add(fMCCosThetaCsFrameTwentyfiveBinsIncohH);

  fPhiCsFrameTwentyfiveBinsIncohH =
        new TH1F( "fPhiCsFrameTwentyfiveBinsIncohH",
                  "fPhiCsFrameTwentyfiveBinsIncohH",
                  25, -3.14, 3.14
                  );
  fOutputList->Add(fPhiCsFrameTwentyfiveBinsIncohH);

  fMCPhiCsFrameTwentyfiveBinsIncohH =
        new TH1F( "fMCPhiCsFrameTwentyfiveBinsIncohH",
                  "fMCPhiCsFrameTwentyfiveBinsIncohH",
                  25, -3.14, 3.14
                  );
  fOutputList->Add(fMCPhiCsFrameTwentyfiveBinsIncohH);

  fTildePhiCsFrameTwentyfiveBinsIncohH =
        new TH1F( "fTildePhiCsFrameTwentyfiveBinsIncohH",
                  "fTildePhiCsFrameTwentyfiveBinsIncohH",
                  // 25, -3.14*7.0*0.25, 3.14*3.0*0.25
                  25, 0, 2. * 3.14
                  );
  fOutputList->Add(fTildePhiCsFrameTwentyfiveBinsIncohH);

  fMCTildePhiCsFrameTwentyfiveBinsIncohH =
        new TH1F( "fMCTildePhiCsFrameTwentyfiveBinsIncohH",
                  "fMCTildePhiCsFrameTwentyfiveBinsIncohH",
                  // 25, -3.14*7.0*0.25, 3.14*3.0*0.25
                  25, 0, 2. * 3.14
                  );
  fOutputList->Add(fMCTildePhiCsFrameTwentyfiveBinsIncohH);
  ...
  fOutputList->Add(fMCCosThetaCsFrameQuantumTwentyfiveBinsH);

  fMCPhiCsFrameQuantumTwentyfiveBinsH =
        new TH1F( "fMCPhiCsFrameQuantumTwentyfiveBinsH",
                  "fMCPhiCsFrameQuantumTwentyfiveBinsH",
                  2000, -31.4, 31.4
                  // 100, -3.14, 3.14
                  );
  fOutputList->Add(fMCPhiCsFrameQuantumTwentyfiveBinsH);

  fMCCosThetaCsVsQuantumCsH =
        new TH2F( "fMCCosThetaCsVsQuantumCsH",
                  "fMCCosThetaCsVsQuantumCsH",
                  2000, -10., 10.,
                  2000, -10., 10.
                  // 100, -1., 1.,
  ...
  fOutputList->Add(fMCCosThetaCsVsQuantumCsH);

  fMCPhiCsVsQuantumCsH =
        new TH2F( "fMCPhiCsVsQuantumCsH",
                  "fMCPhiCsVsQuantumCsH",
                  2000, -31.4, 31.4,
                  2000, -31.4, 31.4
                  // 100, -3.14, 3.14,
  ...
  fOutputList->Add(fMCPhiCsVsQuantumCsH);

  fMCCosThetaCsMinusQuantumCsH =
        new TH1F( "fMCCosThetaCsMinusQuantumCsH",
                  "fMCCosThetaCsMinusQuantumCsH",
                  100, -1, 1
                  );
  fOutputList->Add(fMCCosThetaCsMinusQuantumCsH);

  fMCPhiCsMinusQuantumCsH =
        new TH1F( "fMCPhiCsMinusQuantumCsH",
                  "fMCPhiCsMinusQuantumCsH",
                  100, -3.14, 3.14
                  );
  ...
  fCosThetaRecMinusGenHelicityH = new TH1F("fCosThetaRecMinusGenHelicityH", "fCosThetaRecMinusGenHelicityH", 20000, -10, 10);
  fOutputList->Add(fCosThetaRecMinusGenHelicityH);
  fCosThetaRecMinusGenHelicityRelativeH = new TH1F("fCosThetaRecMinusGenHelicityRelativeH", "fCosThetaRecMinusGenHelicityRelativeH", 20000, -10, 10);
  fOutputList->Add(fCosThetaRecMinusGenHelicityRelativeH);
  fPhiRecMinusGenHelicityH = new TH1F("fPhiRecMinusGenHelicityH", "fPhiRecMinusGenHelicityH", 20000, -10, 10);
  fOutputList->Add(fPhiRecMinusGenHelicityH);
  fPhiRecMinusGenHelicityRelativeH = new TH1F("fPhiRecMinusGenHelicityRelativeH", "fPhiRecMinusGenHelicityRelativeH", 20000, -10, 10);
  fOutputList->Add(fPhiRecMinusGenHelicityRelativeH);
  fTildePhiRecMinusGenHelicityH = new TH1F("fTildePhiRecMinusGenHelicityH", "fTildePhiRecMinusGenHelicityH", 20000, -10, 10);
  fOutputList->Add(fTildePhiRecMinusGenHelicityH);
  fTildePhiRecMinusGenHelicityRelativeH = new TH1F("fTildePhiRecMinusGenHelicityRelativeH", "fTildePhiRecMinusGenHelicityRelativeH", 20000, -10, 10);
  fOutputList->Add(fTildePhiRecMinusGenHelicityRelativeH);
  ...
  // fPhiRecVsGenHelicityH = new TH2F( "fPhiRecVsGenHelicityH", "fPhiRecVsGenHelicityH", 25, 0., 2.*TMath::Pi(), 24, 0., 2.*TMath::Pi() );
  fPhiRecVsGenHelicityH = new TH2F( "fPhiRecVsGenHelicityH", "fPhiRecVsGenHelicityH", 600, 0., 2.*TMath::Pi(), 600, 0., 2.*TMath::Pi() );
  fOutputList->Add(fPhiRecVsGenHelicityH);
  // fPhiRecVsGenCSH = new TH2F( "fPhiRecVsGenCSH", "fPhiRecVsGenCSH", 25, 0., 2.*TMath::Pi(), 25, 0., 2.*TMath::Pi() );
  fPhiRecVsGenCSH = new TH2F( "fPhiRecVsGenCSH", "fPhiRecVsGenCSH", 600, 0., 2.*TMath::Pi(), 600, 0., 2.*TMath::Pi() );
  fOutputList->Add(fPhiRecVsGenCSH);

  // fTildePhiRecVsGenHelicityH = new TH2F( "fTildePhiRecVsGenHelicityH", "fTildePhiRecVsGenHelicityH", 25, 0., 2.*TMath::Pi(), 24, 0., 2.*TMath::Pi() );
  fTildePhiRecVsGenHelicityH = new TH2F( "fTildePhiRecVsGenHelicityH", "fTildePhiRecVsGenHelicityH", 600, 0., 2.*TMath::Pi(), 600, 0., 2.*TMath::Pi() );
  fOutputList->Add(fTildePhiRecVsGenHelicityH);
  // fTildePhiRecVsGenCSH = new TH2F( "fTildePhiRecVsGenCSH", "fTildePhiRecVsGenCSH", 25, 0., 2.*TMath::Pi(), 25, 0., 2.*TMath::Pi() );
  fTildePhiRecVsGenCSH = new TH2F( "fTildePhiRecVsGenCSH", "fTildePhiRecVsGenCSH", 600, 0., 2.*TMath::Pi(), 600, 0., 2.*TMath::Pi() );
  fOutputList->Add(fTildePhiRecVsGenCSH);
...
void AliAnalysisTaskUPCforwardMC::UserExec(Option_t *)
{
  ...
  for( Int_t iAngle = 0; iAngle < 2; iAngle++ ) {
    ...
    cosThetaMuonsRestFrame[iAngle]  = dotProductMuonJPsi/( muonsCopyVector.Mag() * possibleJPsiCopyVector.Mag() );
      ...
      /* - NEW: analysis in the INCOHERENT range.
       * -
       */
      if ( (possibleJPsiCopy.Pt() > 0.24999) && (possibleJPsiCopy.Mag() < 3.3) && (possibleJPsiCopy.Mag() > 2.8) ) {
            Double_t CosThetaHelicityFrameValueIncoh  = CosThetaHelicityFrame( muonsCopy2[0], muonsCopy2[1], possibleJPsiCopy );
            Double_t PhiHelicityFrameValueIncoh       =   CosPhiHelicityFrame( muonsCopy2[0], muonsCopy2[1], possibleJPsiCopy );
            Double_t TildePhiPositiveCosThetaIncoh    = PhiHelicityFrameValueIncoh - 0.25 * 3.14;
            Double_t TildePhiNegativeCosThetaIncoh    = PhiHelicityFrameValueIncoh - 0.75 * 3.14;

            Double_t CosThetaCollinsSoperValueIncoh   = CosThetaCollinsSoper(  muonsCopy2[0], muonsCopy2[1], possibleJPsiCopy );
            Double_t PhiCollinsSoperValueIncoh        =   CosPhiCollinsSoper(  muonsCopy2[0], muonsCopy2[1], possibleJPsiCopy );
            Double_t TildePhiPositiveCosThetaCSIncoh  = PhiCollinsSoperValueIncoh - 0.25 * 3.14;
            Double_t TildePhiNegativeCosThetaCSIncoh  = PhiCollinsSoperValueIncoh - 0.75 * 3.14;
             ...
             * - polarisation check.
             */
            Double_t ReweightingCosThetaHEIncoh  = 1.0 / ( 1.0 + CosThetaHelicityFrameValueIncoh          * CosThetaHelicityFrameValueIncoh   );
            Double_t ReweightingCosThetaCSIncoh  = 1.0 / ( 1.0 + 0.66 * CosThetaCollinsSoperValueIncoh    * CosThetaCollinsSoperValueIncoh    );
            Double_t ReweightingCosThetaCS2Incoh = 1.0 / ( 1.0 + CosThetaCollinsSoperValueIncoh           * CosThetaCollinsSoperValueIncoh    );


            if( TildePhiPositiveCosThetaIncoh < 0. ) {
              TildePhiPositiveCosThetaIncoh += 2 * TMath::Pi();
            }
            if( TildePhiNegativeCosThetaIncoh < 0. ) {
              TildePhiNegativeCosThetaIncoh += 2 * TMath::Pi();
            }

            if( TildePhiPositiveCosThetaCSIncoh < 0. ) {
              TildePhiPositiveCosThetaCSIncoh += 2. * TMath::Pi();
            }
            if( TildePhiNegativeCosThetaCSIncoh < 0. ) {
              TildePhiNegativeCosThetaCSIncoh += 2. * TMath::Pi();
            }

            /* - HELICITY FRAME ANALYSIS
             * -
             */
            fCosThetaHelicityFrameTwentyfiveBinsIncohH->Fill( CosThetaHelicityFrameValueIncoh );
            // fCosThetaHelicityFrameTwentyfiveBinsIncohH->Fill( CosThetaHelicityFrameValueIncoh, ReweightingCosThetaHEIncoh );
            fPhiHelicityFrameTwentyfiveBinsIncohH     ->Fill( PhiHelicityFrameValueIncoh );
            if( CosThetaHelicityFrameValueIncoh > 0 ){
              fTildePhiHelicityFrameTwentyfiveBinsIncohH->Fill( TildePhiPositiveCosThetaIncoh );
            } else {
              fTildePhiHelicityFrameTwentyfiveBinsIncohH->Fill( TildePhiNegativeCosThetaIncoh );
            }

            /* - COLLINS-SOPER ANALYSIS
             * -
             */
            fCosThetaCsFrameTwentyfiveBinsIncohH->Fill( CosThetaCollinsSoperValueIncoh );
            // fCosThetaCsFrameTwentyfiveBinsIncohH->Fill( CosThetaCollinsSoperValueIncoh, ReweightingCosThetaCSIncoh  );
            fPhiCsFrameTwentyfiveBinsIncohH     ->Fill( PhiCollinsSoperValueIncoh );
            if( CosThetaCollinsSoperValueIncoh > 0 ){
              fTildePhiCsFrameTwentyfiveBinsIncohH->Fill( TildePhiPositiveCosThetaCSIncoh );
            } else {
              fTildePhiCsFrameTwentyfiveBinsIncohH->Fill( TildePhiNegativeCosThetaCSIncoh );
            }
  ...
  if ( (possibleJPsiCopy.Mag() > 2.85) && (possibleJPsiCopy.Mag() < 3.35) && (possibleJPsiCopy.Pt() < 0.25) ) {
    ...
    if ( (possibleJPsiCopy.Pt() < 0.25) && (possibleJPsiCopy.Mag() < 3.35) && (possibleJPsiCopy.Mag() > 2.85) ) {
          ...
          Double_t CosThetaHEtoCSvalue          = CosThetaHEtoCS(        muonsCopy2[0], muonsCopy2[1], possibleJPsiCopy );
          ...
          Double_t TildePhiPositiveCosThetav2   = PhiHelicityFrameValue10 - 0.25 * TMath::Pi();
          Double_t TildePhiNegativeCosThetav2   = PhiHelicityFrameValue10 - 0.75 * TMath::Pi();
          ...
          fCosThetaHEtoCSH                     ->Fill( TMath::ACos(CosThetaHEtoCSvalue)          );
          fCosThetaRecMinusGenHelicityH        ->Fill( CosThetaHelicityFrameValue10-fCosThetaGeneratedHelicityFrame );
          fCosThetaRecMinusGenHelicityRelativeH->Fill( 1.-fCosThetaGeneratedHelicityFrame/CosThetaHelicityFrameValue10 );
          fPhiRecMinusGenHelicityH             ->Fill( PhiHelicityFrameValue10-fPhiGeneratedHelicityFrame );
          // fPhiRecMinusGenHelicityRelativeH     ->Fill( 1.-(fPhiGeneratedHelicityFrame + TMath::Pi())/(PhiHelicityFrameValue10 + TMath::Pi()) );
          // if ( TMath::Abs(fPhiGeneratedHelicityFrame-PhiHelicityFrameValue10) > TMath::Pi() ){
          //   fPhiRecMinusGenHelicityRelativeH     ->Fill( (PhiHelicityFrameValue10 - fPhiGeneratedHelicityFrame + 2.*TMath::Pi())/(PhiHelicityFrameValue10 + 2.*TMath::Pi()) );
          // } else {
          //   fPhiRecMinusGenHelicityRelativeH     ->Fill( 1.-fPhiGeneratedHelicityFrame/PhiHelicityFrameValue10 );
          // }
          fPhiRecMinusGenHelicityRelativeH     ->Fill( 1.-(fPhiGeneratedHelicityFrame + TMath::Pi())/(PhiHelicityFrameValue10 + TMath::Pi()) );
          if( CosThetaHelicityFrameValue10 > 0 ){
            fTildePhiRecMinusGenHelicityH        ->Fill( TildePhiPositiveCosThetav2 - fTildePhiGeneratedHelicityFramePos );
            fTildePhiRecMinusGenHelicityRelativeH->Fill( 1.-fTildePhiGeneratedHelicityFramePos/TildePhiPositiveCosThetav2 );
          } else {
            fTildePhiRecMinusGenHelicityH        ->Fill( TildePhiNegativeCosThetav2 - fTildePhiGeneratedHelicityFrameNeg );
            fTildePhiRecMinusGenHelicityRelativeH->Fill( 1.-fTildePhiGeneratedHelicityFrameNeg/TildePhiNegativeCosThetav2 );
          }
          ...
          fPhiHelicityFrameTwentyfiveBinsHv2   ->Fill( PhiHelicityFrameValue10 + TMath::Pi() );
          fPhiRecVsGenHelicityH->Fill( PhiHelicityFrameValue10 + TMath::Pi() , fPhiGeneratedHelicityFrame + TMath::Pi()  );
          if ( (CosThetaHelicityFrameValue10 > -0.6) && (CosThetaHelicityFrameValue10 < 0.6) ) {
            fPhiHelicityFrameTwentyfiveBinsHv2_restrict->Fill( PhiHelicityFrameValue10 + TMath::Pi() );
            // fPhiRecVsGenHelicityH->Fill( PhiHelicityFrameValue10 + TMath::Pi() , fPhiGeneratedHelicityFrame + TMath::Pi()  );
          }
          ...
          if ( (track[0]->Pt() > 0.85) && (track[1]->Pt() > 0.85) ) fPhiHelicityFrameTwentyfiveBinsTriggerHv2[0]->Fill( PhiHelicityFrameValue10 + TMath::Pi()  );
          if ( (track[0]->Pt() > 0.90) && (track[1]->Pt() > 0.90) ) fPhiHelicityFrameTwentyfiveBinsTriggerHv2[1]->Fill( PhiHelicityFrameValue10 + TMath::Pi()  );
          if ( (track[0]->Pt() > 0.95) && (track[1]->Pt() > 0.95) ) fPhiHelicityFrameTwentyfiveBinsTriggerHv2[2]->Fill( PhiHelicityFrameValue10 + TMath::Pi()  );
          if ( (track[0]->Pt() > 1.00) && (track[1]->Pt() > 1.00) ) fPhiHelicityFrameTwentyfiveBinsTriggerHv2[3]->Fill( PhiHelicityFrameValue10 + TMath::Pi()  );
          if ( (track[0]->Pt() > 1.05) && (track[1]->Pt() > 1.05) ) fPhiHelicityFrameTwentyfiveBinsTriggerHv2[4]->Fill( PhiHelicityFrameValue10 + TMath::Pi()  );
          if ( (track[0]->Pt() > 1.10) && (track[1]->Pt() > 1.10) ) fPhiHelicityFrameTwentyfiveBinsTriggerHv2[5]->Fill( PhiHelicityFrameValue10 + TMath::Pi()  );
          if ( (track[0]->Pt() > 1.15) && (track[1]->Pt() > 1.15) ) fPhiHelicityFrameTwentyfiveBinsTriggerHv2[6]->Fill( PhiHelicityFrameValue10 + TMath::Pi()  );



          if( CosThetaHelicityFrameValue10 > 0 ){
            fTildePhiHelicityFrameTwentyfiveBinsH  ->Fill( TildePhiPositiveCosTheta );
            fTildePhiHelicityFrameTwentyfiveBinsHv2->Fill( TildePhiPositiveCosThetav2 );
            fTildePhiRecVsGenHelicityH->Fill( TildePhiPositiveCosThetav2,  fTildePhiGeneratedHelicityFramePos  );
            if ( CosThetaHelicityFrameValue10 < 0.6 ) {
              fTildePhiHelicityFrameTwentyfiveBinsHv2_restrict->Fill( TildePhiPositiveCosThetav2 );
              // fTildePhiRecVsGenHelicityH->Fill( TildePhiPositiveCosThetav2,  fTildePhiGeneratedHelicityFramePos  );
            }
            ...
            if ( (track[0]->Pt() > 0.85) && (track[1]->Pt() > 0.85) ) fTildePhiHelicityFrameTwentyfiveBinsTriggerHv2[0]->Fill( TildePhiPositiveCosThetav2 );
            if ( (track[0]->Pt() > 0.90) && (track[1]->Pt() > 0.90) ) fTildePhiHelicityFrameTwentyfiveBinsTriggerHv2[1]->Fill( TildePhiPositiveCosThetav2 );
            if ( (track[0]->Pt() > 0.95) && (track[1]->Pt() > 0.95) ) fTildePhiHelicityFrameTwentyfiveBinsTriggerHv2[2]->Fill( TildePhiPositiveCosThetav2 );
            if ( (track[0]->Pt() > 1.00) && (track[1]->Pt() > 1.00) ) fTildePhiHelicityFrameTwentyfiveBinsTriggerHv2[3]->Fill( TildePhiPositiveCosThetav2 );
            if ( (track[0]->Pt() > 1.05) && (track[1]->Pt() > 1.05) ) fTildePhiHelicityFrameTwentyfiveBinsTriggerHv2[4]->Fill( TildePhiPositiveCosThetav2 );
            if ( (track[0]->Pt() > 1.10) && (track[1]->Pt() > 1.10) ) fTildePhiHelicityFrameTwentyfiveBinsTriggerHv2[5]->Fill( TildePhiPositiveCosThetav2 );
            if ( (track[0]->Pt() > 1.15) && (track[1]->Pt() > 1.15) ) fTildePhiHelicityFrameTwentyfiveBinsTriggerHv2[6]->Fill( TildePhiPositiveCosThetav2 );

          } else {
            fTildePhiHelicityFrameTwentyfiveBinsH  ->Fill( TildePhiNegativeCosTheta );
            fTildePhiHelicityFrameTwentyfiveBinsHv2->Fill( TildePhiNegativeCosThetav2 );
            fTildePhiRecVsGenHelicityH->Fill( TildePhiNegativeCosThetav2,  fTildePhiGeneratedHelicityFrameNeg  );
            if ( CosThetaHelicityFrameValue10 > -0.6 ) {
              fTildePhiHelicityFrameTwentyfiveBinsHv2_restrict->Fill( TildePhiNegativeCosThetav2 );
              // fTildePhiRecVsGenHelicityH->Fill( TildePhiNegativeCosThetav2,  fTildePhiGeneratedHelicityFrameNeg  );
            ...
            if ( (track[0]->Pt() > 0.85) && (track[1]->Pt() > 0.85) ) fTildePhiHelicityFrameTwentyfiveBinsTriggerHv2[0]->Fill( TildePhiNegativeCosThetav2 );
            if ( (track[0]->Pt() > 0.90) && (track[1]->Pt() > 0.90) ) fTildePhiHelicityFrameTwentyfiveBinsTriggerHv2[1]->Fill( TildePhiNegativeCosThetav2 );
            if ( (track[0]->Pt() > 0.95) && (track[1]->Pt() > 0.95) ) fTildePhiHelicityFrameTwentyfiveBinsTriggerHv2[2]->Fill( TildePhiNegativeCosThetav2 );
            if ( (track[0]->Pt() > 1.00) && (track[1]->Pt() > 1.00) ) fTildePhiHelicityFrameTwentyfiveBinsTriggerHv2[3]->Fill( TildePhiNegativeCosThetav2 );
            if ( (track[0]->Pt() > 1.05) && (track[1]->Pt() > 1.05) ) fTildePhiHelicityFrameTwentyfiveBinsTriggerHv2[4]->Fill( TildePhiNegativeCosThetav2 );
            if ( (track[0]->Pt() > 1.10) && (track[1]->Pt() > 1.10) ) fTildePhiHelicityFrameTwentyfiveBinsTriggerHv2[5]->Fill( TildePhiNegativeCosThetav2 );
            if ( (track[0]->Pt() > 1.15) && (track[1]->Pt() > 1.15) ) fTildePhiHelicityFrameTwentyfiveBinsTriggerHv2[6]->Fill( TildePhiNegativeCosThetav2 );
          }
          ...
          fPhiCsFrameTwentyfiveBinsHv2   ->Fill( PhiCollinsSoperValue + TMath::Pi() );
          if ( (CosThetaCollinsSoperValue > -0.6) && (CosThetaCollinsSoperValue < 0.6) ){
            fPhiCsFrameTwentyfiveBinsHv2_restrict->Fill( PhiCollinsSoperValue + TMath::Pi() );
            // fPhiCsFrameTwentyfiveBinsHv2_restrict->Fill( PhiCollinsSoperValue + TMath::Pi() );
          }
          ...
          if ( (track[0]->Pt() > 0.85) && (track[1]->Pt() > 0.85) ) fPhiCsFrameTwentyfiveBinsTriggerHv2[0]->Fill( PhiCollinsSoperValue + TMath::Pi() );
          if ( (track[0]->Pt() > 0.90) && (track[1]->Pt() > 0.90) ) fPhiCsFrameTwentyfiveBinsTriggerHv2[1]->Fill( PhiCollinsSoperValue + TMath::Pi() );
          if ( (track[0]->Pt() > 0.95) && (track[1]->Pt() > 0.95) ) fPhiCsFrameTwentyfiveBinsTriggerHv2[2]->Fill( PhiCollinsSoperValue + TMath::Pi() );
          if ( (track[0]->Pt() > 1.00) && (track[1]->Pt() > 1.00) ) fPhiCsFrameTwentyfiveBinsTriggerHv2[3]->Fill( PhiCollinsSoperValue + TMath::Pi() );
          if ( (track[0]->Pt() > 1.05) && (track[1]->Pt() > 1.05) ) fPhiCsFrameTwentyfiveBinsTriggerHv2[4]->Fill( PhiCollinsSoperValue + TMath::Pi() );
          if ( (track[0]->Pt() > 1.10) && (track[1]->Pt() > 1.10) ) fPhiCsFrameTwentyfiveBinsTriggerHv2[5]->Fill( PhiCollinsSoperValue + TMath::Pi() );
          if ( (track[0]->Pt() > 1.15) && (track[1]->Pt() > 1.15) ) fPhiCsFrameTwentyfiveBinsTriggerHv2[6]->Fill( PhiCollinsSoperValue + TMath::Pi() );

          if( CosThetaCollinsSoperValue > 0 ){
            fTildePhiCsFrameTwentyfiveBinsH  ->Fill( TildePhiPositiveCosThetaCS );
            fTildePhiCsFrameTwentyfiveBinsHv2->Fill( TildePhiPositiveCosThetaCSv2 );
            if ( CosThetaCollinsSoperValue < 0.6 ) {
              fTildePhiCsFrameTwentyfiveBinsHv2_restrict->Fill( TildePhiPositiveCosThetaCSv2 );
            }
            ...
            if ( (track[0]->Pt() > 0.85) && (track[1]->Pt() > 0.85) ) fTildePhiCsFrameTwentyfiveBinsTriggerHv2[0]->Fill( TildePhiPositiveCosThetaCSv2 );
            if ( (track[0]->Pt() > 0.90) && (track[1]->Pt() > 0.90) ) fTildePhiCsFrameTwentyfiveBinsTriggerHv2[1]->Fill( TildePhiPositiveCosThetaCSv2 );
            if ( (track[0]->Pt() > 0.95) && (track[1]->Pt() > 0.95) ) fTildePhiCsFrameTwentyfiveBinsTriggerHv2[2]->Fill( TildePhiPositiveCosThetaCSv2 );
            if ( (track[0]->Pt() > 1.00) && (track[1]->Pt() > 1.00) ) fTildePhiCsFrameTwentyfiveBinsTriggerHv2[3]->Fill( TildePhiPositiveCosThetaCSv2 );
            if ( (track[0]->Pt() > 1.05) && (track[1]->Pt() > 1.05) ) fTildePhiCsFrameTwentyfiveBinsTriggerHv2[4]->Fill( TildePhiPositiveCosThetaCSv2 );
            if ( (track[0]->Pt() > 1.10) && (track[1]->Pt() > 1.10) ) fTildePhiCsFrameTwentyfiveBinsTriggerHv2[5]->Fill( TildePhiPositiveCosThetaCSv2 );
            if ( (track[0]->Pt() > 1.15) && (track[1]->Pt() > 1.15) ) fTildePhiCsFrameTwentyfiveBinsTriggerHv2[6]->Fill( TildePhiPositiveCosThetaCSv2 );
          } else {
            fTildePhiCsFrameTwentyfiveBinsH  ->Fill( TildePhiNegativeCosThetaCS );
            fTildePhiCsFrameTwentyfiveBinsHv2->Fill( TildePhiNegativeCosThetaCSv2 );
            if ( CosThetaCollinsSoperValue > -0.6 ) {
              fTildePhiCsFrameTwentyfiveBinsHv2_restrict->Fill( TildePhiNegativeCosThetaCSv2 );
            }
            ...
            if ( (track[0]->Pt() > 0.85) && (track[1]->Pt() > 0.85) ) fTildePhiCsFrameTwentyfiveBinsTriggerHv2[0]->Fill( TildePhiNegativeCosThetaCSv2 );
            if ( (track[0]->Pt() > 0.90) && (track[1]->Pt() > 0.90) ) fTildePhiCsFrameTwentyfiveBinsTriggerHv2[1]->Fill( TildePhiNegativeCosThetaCSv2 );
            if ( (track[0]->Pt() > 0.95) && (track[1]->Pt() > 0.95) ) fTildePhiCsFrameTwentyfiveBinsTriggerHv2[2]->Fill( TildePhiNegativeCosThetaCSv2 );
            if ( (track[0]->Pt() > 1.00) && (track[1]->Pt() > 1.00) ) fTildePhiCsFrameTwentyfiveBinsTriggerHv2[3]->Fill( TildePhiNegativeCosThetaCSv2 );
            if ( (track[0]->Pt() > 1.05) && (track[1]->Pt() > 1.05) ) fTildePhiCsFrameTwentyfiveBinsTriggerHv2[4]->Fill( TildePhiNegativeCosThetaCSv2 );
            if ( (track[0]->Pt() > 1.10) && (track[1]->Pt() > 1.10) ) fTildePhiCsFrameTwentyfiveBinsTriggerHv2[5]->Fill( TildePhiNegativeCosThetaCSv2 );
            if ( (track[0]->Pt() > 1.15) && (track[1]->Pt() > 1.15) ) fTildePhiCsFrameTwentyfiveBinsTriggerHv2[6]->Fill( TildePhiNegativeCosThetaCSv2 );
          }
  ...
  if ( possibleJPsiCopy.Pt() < 0.25 ) {
        ...
        for(Int_t iPhiBinsV2 = 0; iPhiBinsV2 < 25; iPhiBinsV2++) {
          ...
          if( (PhiHelicityFrameValue7 + TMath::Pi()) < 2.*TMath::Pi()*((Double_t)iPhiBinsV2 + 1.)/25. ){
            fInvariantMassDistributionOnlyPhiHeFrameTwentyfiveBinsHv2[iPhiBinsV2]->Fill(possibleJPsiCopy.Mag());
            controlFlag14a = 1;
          }
        }
        if( (CosThetaHelicityFrameValue7 > 0) || (CosThetaHelicityFrameValue7 == 0) ){
          ...
          for(Int_t iTildePhiBinsV2 = 0; iTildePhiBinsV2 < 25; iTildePhiBinsV2++) {
            ...
            if( (TildePhiPositiveCosThetav2) < 2.*TMath::Pi()*((Double_t)iTildePhiBinsV2 + 1.)/25. ){
              fInvariantMassDistributionOnlyTildePhiHeFrameTwentyfiveBinsHv2[iTildePhiBinsV2]->Fill(possibleJPsiCopy.Mag());
              controlFlag15a = 1;
            }
          }
        ...
        for(Int_t iPhiBinsV2 = 0; iPhiBinsV2 < 25; iPhiBinsV2++) {
          ...
          if( (PhiCollinsSoperValue + TMath::Pi()) < 2.*TMath::Pi()*((Double_t)iPhiBinsV2 + 1.)/25. ){
            fInvariantMassDistributionOnlyPhiCsFrameTwentyfiveBinsHv2[iPhiBinsV2]->Fill(possibleJPsiCopy.Mag());
            controlFlag17a = 1;
          }
        }
        if( (CosThetaCollinsSoperValue > 0) || (CosThetaCollinsSoperValue == 0) ){
          ...
          for(Int_t iTildePhiBinsV2 = 0; iTildePhiBinsV2 < 25; iTildePhiBinsV2++) {
            ...
            if( (TildePhiPositiveCosThetaCSv2) < 2.*TMath::Pi()*((Double_t)iTildePhiBinsV2 + 1.)/25. ){
              fInvariantMassDistributionOnlyTildePhiCsFrameTwentyfiveBinsHv2[iTildePhiBinsV2]->Fill(possibleJPsiCopy.Mag());
              controlFlag18a = 1;
            }
          }
...
void AliAnalysisTaskUPCforwardMC::ProcessMCParticles(AliMCEvent* fMCEventArg)
{
  ...
  // Loop over the MC tracks
  for(int iPart = 0; iPart < (fMCEventArg->GetNumberOfTracks()); iPart++) {
    fTildePhiGeneratedHelicityFramePos = -999.;
    fTildePhiGeneratedHelicityFrameNeg = -999.;
    fPhiGeneratedHelicityFrame         = -999.;
  ...
  if( nGoodMuonsMC == 2 ) {
    ...
    if( charge[0] != charge[1] ) {
      ...
      //
      // Incoherent analysis for crosscheck
      //
      if ( (possibleJPsiMC.Mag() > 2.8) && (possibleJPsiMC.Mag() < 3.3) && (possibleJPsiMC.Pt() > 0.24999) ) {
          if( charge[0] > 0 ) {
                // HELICITY
                Double_t CosThetaHeForTrialIncoh    = CosThetaHelicityFrame(muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC);
                Double_t CosThetaCsForTrialIncoh    = CosThetaCollinsSoper( muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC);
                Double_t ReweightedCosThetaHEIncoh  = 1.0 / ( 1.0 + CosThetaHeForTrialIncoh * CosThetaHeForTrialIncoh );
                Double_t ReweightedCosThetaCSIncoh  = 1.0 / ( 1.0 + 0.66 * CosThetaCsForTrialIncoh * CosThetaCsForTrialIncoh );
                Double_t ReweightedCosThetaCS2Incoh = 1.0 / ( 1.0 + CosThetaCsForTrialIncoh * CosThetaCsForTrialIncoh );
                fMCCosThetaHelicityFrameTwentyfiveBinsIncohH->Fill( CosThetaHeForTrialIncoh );
                fMCPhiHelicityFrameTwentyfiveBinsIncohH->Fill( CosPhiHelicityFrame(      muonsMCcopy[0],
                                                                                         muonsMCcopy[1],
                                                                                         possibleJPsiMC
                                                                                         )
                                                                                        );
                if( CosThetaHelicityFrame(muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC) > 0 ){
                  Double_t PhiHelicityFrameValueTruthIncoh  = CosPhiHelicityFrame( muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC );
                  Double_t TildePhiPositiveCosThetaIncoh    = PhiHelicityFrameValueTruthIncoh - 0.25 * 3.14;
                  Double_t TildePhiNegativeCosThetaIncoh    = PhiHelicityFrameValueTruthIncoh - 0.75 * 3.14;
                  if( TildePhiPositiveCosThetaIncoh < 0. ) {
                    TildePhiPositiveCosThetaIncoh += 2. * TMath::Pi();
                  }
                  if( TildePhiNegativeCosThetaIncoh < 0. ) {
                  ...
                  fMCTildePhiHelicityFrameTwentyfiveBinsIncohH->Fill( TildePhiPositiveCosThetaIncoh );
                } else {
                  Double_t PhiHelicityFrameValueTruthIncoh  = CosPhiHelicityFrame( muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC );
                  Double_t TildePhiPositiveCosThetaIncoh    = PhiHelicityFrameValueTruthIncoh - 0.25 * 3.14;
                  Double_t TildePhiNegativeCosThetaIncoh    = PhiHelicityFrameValueTruthIncoh - 0.75 * 3.14;
                  ...
                  fMCTildePhiHelicityFrameTwentyfiveBinsIncohH->Fill( TildePhiNegativeCosThetaIncoh );
                }
                /* - COLLINS-SOPER ANALYSIS
                 * -
                 */
                // fMCCosThetaCsFrameTwentyfiveBinsIncohH->Fill( CosThetaCollinsSoper(      muonsMCcopy[0],
                          //                                                                muonsMCcopy[1],
                          //                                                                possibleJPsiMC
                          //                                                                )
                          //                                                               );
                fMCCosThetaCsFrameTwentyfiveBinsIncohH->Fill( CosThetaCsForTrialIncoh );
                fMCPhiCsFrameTwentyfiveBinsIncohH->Fill( CosPhiCollinsSoper(      muonsMCcopy[0],
                                                                                  muonsMCcopy[1],
                                                                                  possibleJPsiMC
                                                                                  )
                                                                                 );
                if( CosThetaCollinsSoper(muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC) > 0 ){
                  Double_t PhiCsFrameValueTruthIncoh          = CosPhiCollinsSoper( muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC );
                  Double_t TildePhiPositiveCosThetaCSIncoh    = PhiCsFrameValueTruthIncoh - 0.25 * 3.14;
                  Double_t TildePhiNegativeCosThetaCSIncoh    = PhiCsFrameValueTruthIncoh - 0.75 * 3.14;
                  if( TildePhiPositiveCosThetaCSIncoh < 0. ) {
                    TildePhiPositiveCosThetaCSIncoh += 2. * TMath::Pi();
                  }
                  if( TildePhiNegativeCosThetaCSIncoh < 0. ) {
                  ...
                  fMCTildePhiCsFrameTwentyfiveBinsIncohH->Fill( TildePhiPositiveCosThetaCSIncoh );
                } else {
                  Double_t PhiCsFrameValueTruthIncoh  = CosPhiCollinsSoper( muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC );
                  Double_t TildePhiPositiveCosThetaCSIncoh    = PhiCsFrameValueTruthIncoh - 0.25 * 3.14;
                  Double_t TildePhiNegativeCosThetaCSIncoh    = PhiCsFrameValueTruthIncoh - 0.75 * 3.14;
                  ...
                  fMCTildePhiCsFrameTwentyfiveBinsIncohH->Fill( TildePhiNegativeCosThetaCSIncoh );
                }
                ...
                // HELICITY
                Double_t CosThetaHeForTrialIncoh    = CosThetaHelicityFrame(muonsMCcopy[1],muonsMCcopy[0],possibleJPsiMC);
                Double_t CosThetaCsForTrialIncoh    = CosThetaCollinsSoper( muonsMCcopy[1],muonsMCcopy[0],possibleJPsiMC);
                Double_t ReweightedCosThetaHEIncoh  = 1.0 / ( 1.0 + CosThetaHeForTrialIncoh * CosThetaHeForTrialIncoh );
                Double_t ReweightedCosThetaCSIncoh  = 1.0 / ( 1.0 + 0.66 * CosThetaCsForTrialIncoh * CosThetaCsForTrialIncoh );
                Double_t ReweightedCosThetaCS2Incoh = 1.0 / ( 1.0 + CosThetaCsForTrialIncoh * CosThetaCsForTrialIncoh );
                fMCCosThetaHelicityFrameTwentyfiveBinsIncohH->Fill( CosThetaHeForTrialIncoh );
                fMCPhiHelicityFrameTwentyfiveBinsIncohH->Fill(     CosPhiHelicityFrame(  muonsMCcopy[1],
                                                                                         muonsMCcopy[0],
                                                                                         possibleJPsiMC
                                                                                         )
                                                                                        );
                if( CosThetaHelicityFrame(muonsMCcopy[1],muonsMCcopy[0],possibleJPsiMC) > 0 ){
                  Double_t PhiHelicityFrameValueTruthIncoh  = CosPhiHelicityFrame( muonsMCcopy[1],muonsMCcopy[0],possibleJPsiMC );
                  Double_t TildePhiPositiveCosThetaIncoh    = PhiHelicityFrameValueTruthIncoh - 0.25 * 3.14;
                  Double_t TildePhiNegativeCosThetaIncoh    = PhiHelicityFrameValueTruthIncoh - 0.75 * 3.14;
                  if( TildePhiPositiveCosThetaIncoh < 0. ) {
                    TildePhiPositiveCosThetaIncoh += 2. * TMath::Pi();
                ...
                // fMCCosThetaCsFrameTwentyfiveBinsIncohH->Fill(   CosThetaCollinsSoper(  muonsMCcopy[0],
                          ...
                          //                                                               );
                fMCCosThetaCsFrameTwentyfiveBinsIncohH->Fill( CosThetaCsForTrialIncoh );
                fMCPhiCsFrameTwentyfiveBinsIncohH->Fill(     CosPhiCollinsSoper(  muonsMCcopy[1],
                                                                                  muonsMCcopy[0],
                                                                                  possibleJPsiMC
                                                                                  )
                                                                                 );
                if( CosThetaCollinsSoper(muonsMCcopy[1],muonsMCcopy[0],possibleJPsiMC) > 0 ){
                  Double_t PhiCsFrameValueTruthIncoh          = CosPhiCollinsSoper( muonsMCcopy[1],muonsMCcopy[0],possibleJPsiMC );
                  Double_t TildePhiPositiveCosThetaCSIncoh    = PhiCsFrameValueTruthIncoh - 0.25 * 3.14;
                  Double_t TildePhiNegativeCosThetaCSIncoh    = PhiCsFrameValueTruthIncoh - 0.75 * 3.14;
                  if( TildePhiPositiveCosThetaCSIncoh < 0. ) {
                    TildePhiPositiveCosThetaCSIncoh += 2. * TMath::Pi();
      ...
      if ( (possibleJPsiMC.Mag() > 2.8) && (possibleJPsiMC.Mag() < 3.3) && (possibleJPsiMC.Pt() < 0.25) ) {
          if( charge[0] > 0 ) {
                  ...
                  Double_t CosThetaHEtoCSMC     = CosThetaHEtoCS(       muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC);
                  // Double_t CosThetaHeForTrial   = CosThetaHelicityFrame(muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC);
                  Double_t CosThetaCsQuantum    = CosThetaQuantumTomCS( muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC);
                  Double_t PhiCsFrameStandard   = CosPhiCollinsSoper(   muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC);
                  Double_t PhiCsQuantum         = PhiQuantumTomogrCS(   muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC);
                  ...
                  fMCCosThetaHEtoCSH                     ->Fill( TMath::ACos(CosThetaHEtoCSMC) );
                  ...
                  fMCPhiHelicityFrameTwentyfiveBinsHv2->Fill( CosPhiHelicityFrame(muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC) + TMath::Pi() );
                  if ( (CosThetaHeForTrial > -0.6) && (CosThetaHeForTrial < 0.6) ) {
                    fMCPhiHelicityFrameTwentyfiveBinsHv2_restrict->Fill( CosPhiHelicityFrame(muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC) + TMath::Pi() );
                  }
                  ...
                  if( CosThetaHelicityFrame(muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC) > 0 ){
                    ...
                    Double_t TildePhiPositiveCosThetav2  = PhiHelicityFrameValueTruth - 0.25 * TMath::Pi() ;
                    Double_t TildePhiNegativeCosThetav2  = PhiHelicityFrameValueTruth - 0.75 * TMath::Pi() ;
                    if( TildePhiPositiveCosTheta < 0. ) {
                      TildePhiPositiveCosTheta += 2. * TMath::Pi();
                    }
                    if( TildePhiNegativeCosTheta < 0. ) {
                    ...
                    fMCTildePhiHelicityFrameTwentyfiveBinsHv2->Fill( TildePhiPositiveCosThetav2 );
                    fTildePhiGeneratedHelicityFramePos = TildePhiPositiveCosThetav2;
                    if ( CosThetaHelicityFrame(muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC) < 0.6 ){
                      fMCTildePhiHelicityFrameTwentyfiveBinsHv2_restrict->Fill( TildePhiPositiveCosThetav2 );
                    }
                  } else {
                    Double_t PhiHelicityFrameValueTruth  = CosPhiHelicityFrame( muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC );
                    Double_t TildePhiPositiveCosTheta    = PhiHelicityFrameValueTruth - 0.25 * 3.14;
                    ...
                    fMCTildePhiHelicityFrameTwentyfiveBinsHv2->Fill( TildePhiNegativeCosThetav2 );
                    fTildePhiGeneratedHelicityFrameNeg = TildePhiNegativeCosThetav2;
                    if ( CosThetaHelicityFrame(muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC) > (-0.6) ){
                      fMCTildePhiHelicityFrameTwentyfiveBinsHv2_restrict->Fill( TildePhiNegativeCosThetav2 );
                    }
                  ...
                  fMCCosThetaCsFrameQuantumTwentyfiveBinsH->Fill( CosThetaCsQuantum );
                  fMCCosThetaCsMinusQuantumCsH            ->Fill( CosThetaCsForTrial - CosThetaCsQuantum );
                  fMCCosThetaCsVsQuantumCsH               ->Fill( CosThetaCsForTrial,  CosThetaCsQuantum );
                  fMCPhiCsFrameQuantumTwentyfiveBinsH->Fill( PhiCsQuantum );
                  fMCPhiCsMinusQuantumCsH            ->Fill( PhiCsFrameStandard - PhiCsQuantum );
                  fMCPhiCsVsQuantumCsH               ->Fill( PhiCsFrameStandard,  PhiCsQuantum );
                  ...
                  fMCPhiCsFrameTwentyfiveBinsHv2->Fill( CosPhiCollinsSoper(muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC) + TMath::Pi() );
                  if ( (CosThetaCsForTrial > -0.6) && (CosThetaCsForTrial < 0.6) ) {
                    fMCPhiCsFrameTwentyfiveBinsHv2_restrict->Fill( CosPhiCollinsSoper(muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC) + TMath::Pi() );
                  }
                  ...
                  if( CosThetaCollinsSoper(muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC) > 0 ){
                    ...
                    Double_t TildePhiPositiveCosThetaCSv2  = PhiCsFrameValueTruth - 0.25 * TMath::Pi() ;
                    Double_t TildePhiNegativeCosThetaCSv2  = PhiCsFrameValueTruth - 0.75 * TMath::Pi() ;
                    if( TildePhiPositiveCosThetaCS < 0. ) {
                      TildePhiPositiveCosThetaCS += 2. * TMath::Pi();
                    }
                    if( TildePhiNegativeCosThetaCS < 0. ) {
                    ...
                    fMCTildePhiCsFrameTwentyfiveBinsHv2->Fill( TildePhiPositiveCosThetaCSv2 );
                    if ( CosThetaCollinsSoper(muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC) < 0.6 ){
                      fMCTildePhiCsFrameTwentyfiveBinsHv2_restrict->Fill( TildePhiPositiveCosThetaCSv2 );
                    }
                    ...
                    fMCTildePhiCsFrameTwentyfiveBinsHv2->Fill( TildePhiNegativeCosThetaCSv2 );
                    if ( CosThetaCollinsSoper(muonsMCcopy[0],muonsMCcopy[1],possibleJPsiMC) > (-0.6) ){
                      fMCTildePhiCsFrameTwentyfiveBinsHv2_restrict->Fill( TildePhiNegativeCosThetaCSv2 );
                    }
                  ...
                  Double_t CosThetaCsQuantum    = CosThetaQuantumTomCS( muonsMCcopy[1],muonsMCcopy[0],possibleJPsiMC);
                  Double_t PhiCsFrameStandard   = CosPhiCollinsSoper(   muonsMCcopy[1],muonsMCcopy[0],possibleJPsiMC);
                  Double_t PhiCsQuantum         = PhiQuantumTomogrCS(   muonsMCcopy[1],muonsMCcopy[0],possibleJPsiMC);
                  Double_t CosThetaHEtoCSMC     = CosThetaHEtoCS(       muonsMCcopy[1],muonsMCcopy[0],possibleJPsiMC);
                  ...
                  fMCPhiHelicityFrameTwentyfiveBinsHv2->Fill( CosPhiHelicityFrame(muonsMCcopy[1],muonsMCcopy[0],possibleJPsiMC) + TMath::Pi() );
                  if ( (CosThetaHeForTrial > -0.6) && (CosThetaHeForTrial < 0.6) ) {
                    fMCPhiHelicityFrameTwentyfiveBinsHv2_restrict->Fill( CosPhiHelicityFrame(muonsMCcopy[1],muonsMCcopy[0],possibleJPsiMC) + TMath::Pi() );
                  }
                  ...
                  if( CosThetaHelicityFrame(muonsMCcopy[1],muonsMCcopy[0],possibleJPsiMC) > 0 ){
                    ...
                    fMCTildePhiHelicityFrameTwentyfiveBinsHv2->Fill( TildePhiPositiveCosThetav2 );
                    fTildePhiGeneratedHelicityFramePos = TildePhiPositiveCosThetav2;
                    if ( CosThetaHelicityFrame(muonsMCcopy[1],muonsMCcopy[0],possibleJPsiMC) < 0.6 ){
                      fMCTildePhiHelicityFrameTwentyfiveBinsHv2_restrict->Fill( TildePhiPositiveCosThetav2 );
                    }
                  ...
                  fMCPhiCsFrameTwentyfiveBinsHv2->Fill( CosPhiCollinsSoper(muonsMCcopy[1],muonsMCcopy[0],possibleJPsiMC) + TMath::Pi() );
                  if ( (CosThetaCsForTrial > -0.6) && (CosThetaCsForTrial < 0.6) ) {
                    fMCPhiCsFrameTwentyfiveBinsHv2_restrict->Fill( CosPhiCollinsSoper(muonsMCcopy[1],muonsMCcopy[0],possibleJPsiMC) + TMath::Pi() );
                  }
                  ...
                  if( CosThetaCollinsSoper(muonsMCcopy[1],muonsMCcopy[0],possibleJPsiMC) > 0 ){
                      ...
                      fMCTildePhiCsFrameTwentyfiveBinsH  ->Fill( TildePhiPositiveCosThetaCS   );
                      fMCTildePhiCsFrameTwentyfiveBinsHv2->Fill( TildePhiPositiveCosThetaCSv2 );
                      if ( CosThetaCollinsSoper(muonsMCcopy[1],muonsMCcopy[0],possibleJPsiMC) < 0.6 ){
                        fMCTildePhiCsFrameTwentyfiveBinsHv2_restrict->Fill( TildePhiPositiveCosThetaCSv2 );
                      }
...
/* -
   -
 */
Double_t AliAnalysisTaskUPCforwardMC::CosThetaHEtoCS( TLorentzVector muonPositive,
                                                      TLorentzVector muonNegative,
                                                      TLorentzVector possibleJPsi )
{
  Double_t HalfSqrtSnn   = 2510.;
  ...
  TVector3 zaxisCS = (((pProjDimu.Vect()).Unit())-((pTargDimu.Vect()).Unit())).Unit();
  TVector3 zaxisHE = (possibleJPsi.Vect()).Unit();

  Double_t CosThetaHEtoCSvalue = zaxisCS.Dot(zaxisHE.Unit());
  return   CosThetaHEtoCSvalue;
}
//_____________________________________________________________________________
